...
export default function TransporterDashboard({
    ...
    const [transporterCount, setTransporterCount] =
        useState(0);
        ...
        try {
            ...
            const [usersRes, shipmentsRes, countRes] =
                await Promise.all([
                    getUsers(),
                    getShipments(),
                    getRoleCount("TRANSPORTER")
                ]);

            setUsers(usersRes.data);
            setShipments(shipmentsRes.data);
            setTransporterCount(countRes.data.count);
    ...
    const transferCustody = async (
        ...
        try {
            ...
            setTx({
                status: "success",
                message: `Shipment ${shipmentId} transferred to warehouse.`,
                txHash,
                blockNumber
            });
    ...
    return (
        <div>
            <div className="dashboard-head">
                ...
                <WalletInfo
                    wallet={wallet}
                    roleLabel={ROLE_LABELS[3]}
                    roleEmoji={ROLE_EMOJIS[3]}
                />
            </div>
            ...
            {selected && (
                <div className="detail-wrapper">
                    ...
                    <ShipmentDetail
                        ...
                        transferLabel="🏢 Transfer to Warehouse"
                        onTransfer={async (to) => {
