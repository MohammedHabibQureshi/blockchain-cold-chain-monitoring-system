...
export default function WarehouseDashboard({
    ...
    const [warehouseCount, setWarehouseCount] =
        useState(0);
        ...
        try {
            ...
            const [usersRes, shipmentsRes, countRes] =
                await Promise.all([
                    getUsers(),
                    getShipments(),
                    getRoleCount("WAREHOUSE")
                ]);

            setUsers(usersRes.data);
            setShipments(shipmentsRes.data);
            setWarehouseCount(countRes.data.count);
    ...
    const transferCustody = async (
        ...
        try {
            ...
            setTx({
                status: "success",
                message: `Shipment ${shipmentId} transferred to distributor.`,
                txHash,
                blockNumber
            });
    ...
    return (
        <div>
            <div className="dashboard-head">
                ...
                <WalletInfo
                    wallet={wallet}
                    roleLabel={ROLE_LABELS[4]}
                    roleEmoji={ROLE_EMOJIS[4]}
                />
            </div>
